...
const CatalystMilestonesDonut: React.FC<CatalystMilestonesDonutProps> = ({ totalMilestones, completedMilestones }) => {
    ...
    return (
        <div className={styles.donutChartContainer}>
            ...
            <div className={styles.donutLegend}>
                <div
                    className={`${styles.legendItem} ${activeSegment === 'completed' ? styles.active : ''}`}
