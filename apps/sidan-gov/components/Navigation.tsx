...
const socialLinks = [
    {
        name: 'GitHub',
        url: 'https://github.com/Sidan-DRep',
        icon: (
        ...
        <nav className={`${styles.navCard} ${isMobile ? styles.navCardMobile : ''}`}>
            <div className={styles.logoContainer}>
                <div className={styles.logo}>
                    <span className={styles.logoText}>Sidan</span>
                    <span className={styles.logoSubtext}>Governance</span>
                </div>
            </div>
