...
const navItems = [
    ...
    },
    {
        ...
        path: '/constitutional-committee',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 21h18"></path><path d="M5 21V7l8-4v18"></path><path d="M19 21V11l-6-4"></path></svg>
    },
    {
    ...
    },
    {
        name: 'Sidan Stats',
        path: '/org-stats',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
    },
    {
        name: 'Projects',
        path: '/projects',
        ...
        >
            <div className={styles.logoContainer}>
                <div className={styles.logo}>
                    {isExpanded ? (
                        <Image
                            src={config.organization.logoWithName.src}
                            alt={config.organization.displayName}
                            width={config.organization.logoWithName.width}
                            height={config.organization.logoWithName.height}
                            className={styles.logoImage}
                        />
                    ) : (
                        <Image
                            src={config.organization.logo.src}
                            alt={config.organization.displayName}
                            width={config.organization.logo.width}
                            height={config.organization.logo.height}
                            className={styles.logoImage}
                        />
                    )}
                </div>
